""" Functions to calculate ROUGE metric.
Originally taken from https://github.com/miso-belica/sumy
"""
# -*- coding: utf-8 -*-
...
def _get_ngrams(n, text): #pylint: disable=C0103
  """Gets n-grams from text"""
  ngram_set = set()
...
def _get_word_ngrams(n, sentences): #pylint: disable=C0103
  """Get word ngrams from sentences"""
...
def _union_lcs(evaluated_sentences, reference_sentence):
  ...
  For example, if r_i= w1 w2 w3 w4 w5, and C contains two sentences:
  ...
  of r_i and c2 is "w1 w3 w5”. The union longest common subsequence of r_i, c1,
  and c2 is "w1 w2 w3 w5” and LCS_u(r_i, C) = 4/5.
